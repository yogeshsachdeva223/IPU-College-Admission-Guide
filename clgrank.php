...
<link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css'>
      ...
      <link rel="stylesheet" href="cssclgrank/style.css">
...
<div class="row container-fluid">
  ...
  <div class="col-sm-6">
    <h1 style="font-size:50px; color:white; text-align: center;"><u>College Rankings</u></h1>
  </div>
  <div class="col-sm-3"></div>
</div>

<!--TABLE FOR COLLEGE RANKINGS -->
<div style="width:70%" class="container well">        
...
<center>
<div width='33%' class='well' style='text-align:left; margin-left:30%;margin-right:30%'>
		
        <b>MAIT</b> - Maharaja Agrasen Institute Of Technology<br>
		<b>USICT</b> - University School Of Communication and Information Technology<br>
		<b>AIACTR </b>- Ambedkar Institute Of Advanced Communication Technologies and Research<br>
		<b>GBPGEC</b> - G.B Pant Govt. Engineering College<br>
		<b>GEC</b> - Government Engineering College<br>
		<b>DITE</b> - Delhi Institute Of Tool Engineering<br>
		<b>NPTI</b> - National Power Training Institute<br>
		<b>MSIT</b> - Maharaja Surajmal Institute Of Technology<br>
		<b>BPIT</b> - Bhagwan Parshuram Institute Of Technology<br>
		<b>BVP </b>- Bharti Vidyapeeth's College Of Engineering<br>
		<b>GTBIT</b> - Guru Teg Bhadur Institute Of Technology<br>
		<b>HMRITM</b> - HMR Institute Of Technology and Management<br>
		<b>NIEC</b> - Northern India Engineering College<br>
		<b>USCT</b> - University School of Chemical Technology<br>
		<b>ASET</b> - Amity School Of Engineering &amp; Technology<br>
                <b>DTC</b> - Delhi Technical Campus<br>
		&nbsp;</td>
...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
  ...
  {
    echo "<div style='text-align:center' class='well col-sm-6'><p style='font-size:20px'> Your expected rank is between <span > <mark style='color:red'>{$minimum}</mark></span> and <span><mark style='color:red'>{$maximum}</mark></span>.</p></div>"; 
  }
  else
